...
set solution_dir "C:/Users/ai770741/Documents/fibonacci_cp/solution1"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 n W 0x0 "Data signal of n" {{0 32 n W 0 "Bit 31 to 0 Data signal of n"}}} {0x18 result R 0x0 "Data signal of result" {{0 32 result R 0 "Bit 31 to 0 Data signal of result"}}} {0x1c result_ctrl R 0x0 "Control signal of result" {{0 1 result_ap_vld R 0 "Control signal result_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
